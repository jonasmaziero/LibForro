...
numbers, probability vectors, unitaries, state vectors, and density matrices, respectively. The conventions 
...
$ gfortran main.f90 /usr/local/lib/libforro.a /usr/local/lib/libforq.a -llapck -lblas
