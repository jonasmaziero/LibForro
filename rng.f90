...
character(10), dimension(5) :: optg  ! Options for the generators
     ...
     if ((optg(1) == "mt") .or. (optg(1) == "std")) then ;   call init_mt() ! Initializes the Mersenne-Twister rng
...
character(10), dimension(5) :: optg  ! Options for the generators
     ...
     if ((optg(1) == "mt") .or. (optg(1) == "std")) then ;   call rng_mt(d, rn)  ! Calls the Mersenne-Twister rng
